...
class FocusDaemon:
    ...
    def _begin_capture(self):
        if self._busy:
            self._busy = False   # force-reset — previous capture is orphaned
            self._popup = None
        self._busy = True
        # safety timeout — always unblock after 20s regardless of outcome
        QTimer.singleShot(20_000, self._force_unblock)

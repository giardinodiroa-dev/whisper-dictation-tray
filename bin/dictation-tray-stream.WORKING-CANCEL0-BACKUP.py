...
def _mix_loop():
    ...
    while monitor_active:
        try:
            ...
            ref_data = _ref_proc.stdout.read(nb)
        except Exception:
            break
        if len(mic_data) < nb or len(ref_data) < nb:
            break
...
def _stop_monitor():
    global monitor_active, _mic_proc, _ref_proc, _play_proc, monitor_module_id, monitor_ec_id
    monitor_active = False
